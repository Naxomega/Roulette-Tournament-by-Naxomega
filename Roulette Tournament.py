...
def modificateur_course():
    modificateurs = ["Aucun", "Aucun", "Aucun", "Equipe", "Compo Spécifique", "Conduite Assistée", "Type de Véhicule", "Bots", "Objets", "Cylindrée"]
...
def condition_bataille():
    conditions = ["Standard", "Score (Equipe)", "Position Précise", "Position Moyenne", "Battle Royale (Solo)"]
    return random.choice(conditions)
def modificateur_bataille():
    modificateurs = ["Aucun", "Aucun", "Aucun", "Equipe", "Compo Spécifique", "Conduite Assistée", "Type de Véhicule", "Bots", "Objets"]
    return random.choice(modificateurs)
def composition():
